...
import ui.display.message.FloatText;
...
public abstract class GameObject
{
	...
	// awkward patch for now
	public void setBaseShipSpeed()
	{
		if(this instanceof BaseShip)
		{
			maxSpeed = Frame.COLOSSAL_SPEED;
			maxSpeedBase = Frame.COLOSSAL_SPEED;
			acceleration = Frame.COLOSSAL_ACCELERATION;
...
//		maxSpeed = maxSpeedBase;
	...
	public final void move() 
	{
		if(canMove())
		{
			changeSpeed(acceleration, getTheta(), false);
			hasNotMoved = false;
		}
	}
...
//	}
	...
	public final void changeSpeedForcedMovement(float amount, float theta)
	{
		changeSpeed(amount, theta, true);
	}
	
	// Josh Lin's Bug Fix / New Version
	public final void changeSpeed(float amount, float theta, boolean unbounded)
	{ 	
		...
		if(unbounded)
		{
			xSpeed = xSpeed / VelocityMagnitude * amount;
			ySpeed = ySpeed / VelocityMagnitude * amount;
		}

		// Normal movement rules
		else if(VelocityMagnitude > maxSpeed )
		{
...
//		else if(forcedMovementTimer <= 31 && VelocityMagnitude > maxSpeedBase)
//		{
//			xSpeed = xSpeed / VelocityMagnitude * maxSpeedBase;
//			ySpeed = ySpeed / VelocityMagnitude * maxSpeedBase;
//		}
	}	
...
//	}
	...
	public void floatText(String message)
	{
		messages.addMessage(new FloatText(this, message));
	}

	public void floatText(int message)
	{
		messages.addMessage(new FloatText(this, message));
	}

	public void floatText(int message, Color color)
	{
		messages.addMessage(new FloatText(this, message, color));
	}

	public void floatText(String message, int duration)
	{
		messages.addMessage(new FloatText(this, message, duration));
	}
	...
	public void floatText(String message, int duration,  Color color)
	{
		messages.addMessage(new FloatText(this, message, duration, color));
	}
