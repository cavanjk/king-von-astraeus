...
public class Utility 
{
	...
	public static void drawStringLeftCenter(Graphics g, Font f, String message, float x, float y)
	{
		g.setFont(f);
		g.drawString(message, x, y - f.getHeight(message)/2);
	}
	...
	public static void drawStringRightCenter(Graphics g, Font f, String message, float x, float y)
	{
		g.setFont(f);
		g.drawString(message, x - f.getWidth(message), y - f.getHeight(message)/2);
	}
